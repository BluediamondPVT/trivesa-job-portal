...
// =======================================================
// 1. Naya Child Component: Jisme URL Search Params aur Form Logic hai
// =======================================================
function LoginContent() {
  ...
  // Get the redirect route from URL, default is '/jobs'
      ...
      <AnimatePresence>
        {showErrorToast && (
          <motion.div
            ...
            className="absolute top-24 lg:top-12 left-1/2 bg-red-50 text-red-600 px-5 py-3 rounded-full shadow-[0_8px_30px_rgb(239,68,68,0.15)] border border-red-100 flex items-center gap-2.5 z-50 whitespace-nowrap text-[13px] sm:text-sm font-bold"
          >
...
// =======================================================
// 2. Main Exported Component: Jisme Suspense Boundary lagi hai
// =======================================================
export default function LoginPage() {
  return (
    <div className="min-h-[100dvh] bg-white grid grid-cols-1 lg:grid-cols-2 relative overflow-hidden">
      ...
      <Suspense
        fallback={
          // Ek simple loading state jab tak client hydration pura na ho
          <div className="flex w-full h-full items-center justify-center bg-slate-50 min-h-dvh lg:min-h-auto">
            <div className="w-8 h-8 border-4 border-[#1864f4] border-t-transparent rounded-full animate-spin"></div>
          </div>
        }
      >
        <LoginContent />
