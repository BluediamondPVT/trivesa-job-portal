...
const jobs = [
  {
    ...
    time: "2 hours ago",
    salary: "₹12L - ₹18L PA",
    description: "Join our core e-commerce team. Looking for strong fundamentals in MongoDB, Express, React, and Node.js. Experience with high-traffic scalable applications is a plus.",
    logoColor: "bg-[#2874F0]",
    logoText: "F",
    badges: [
  ...
  },
  {
    ...
    time: "5 hours ago",
    salary: "₹15L - ₹22L PA",
    description: "Help us build blazing fast delivery interfaces. You should be an expert in Next.js App Router, SSR, and Tailwind CSS. Obsession with Core Web Vitals is required.",
    logoColor: "bg-[#E23744]",
    logoText: "Z",
    badges: [
  ...
  },
  {
    ...
    time: "11 hours ago",
    salary: "₹20L - ₹30L PA",
    description: "Design premium, Awwwards-worthy experiences for our users. Mastery in Figma, micro-interactions, and a strong portfolio demonstrating minimalistic design is mandatory.",
    logoColor: "bg-black",
    logoText: "C",
    badges: [
      { text: "Full Time", style: "bg-blue-50 text-blue-600" },
  ...
  },
  {
    ...
    time: "1 day ago",
    salary: "₹8L - ₹14L PA",
    description: "Work on highly scalable internal dashboards and consumer-facing apps. Need solid experience with React, Node.js, and cloud infrastructure deployments.",
    logoColor: "bg-[#0A2885]",
    logoText: "J",
    badges: [
      { text: "Full Time", style: "bg-blue-50 text-blue-600" },
  ...
  },
  {
    ...
    time: "2 days ago",
    salary: "₹6L - ₹9L PA",
    description: "Drive organic growth and manage performance marketing campaigns. Solid understanding of technical SEO, Google Analytics, and content strategies is expected.",
    logoColor: "bg-[#FC2779]",
    logoText: "N",
    badges: [
...
export default function JobListingContent() {
  return (
    <div className="flex-1 w-full flex flex-col gap-8">
      ...
      {/* Job Cards List (Full Width Layout) */}
      <div className="flex flex-col gap-5">
        {jobs.map((job) => (
          <div
            key={job.id}
            // 🔥 Increased padding (p-7), rounded corners (rounded-2xl), and smooth premium shadow
          ...
          >
            ...
            <div className="sm:self-start flex shrink-0">
              <button className="p-2.5 bg-gray-50 rounded-full text-gray-400 hover:text-blue-600 hover:bg-blue-50 transition-all">
      ...
      {/* Show More Section (Bottom) */}
      <div className="flex flex-col items-center justify-center mt-10 mb-20 space-y-4">
        <p className="text-sm text-gray-500 font-medium">Showing 10 of 497 jobs</p>
